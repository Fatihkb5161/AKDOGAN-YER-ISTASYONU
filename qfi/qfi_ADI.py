...
back_img_path = f'{images_path / "images" / "ai" / "ai_back.svg"}'
item_img_path = f'{images_path / "images" / "ai" / "ai_case.svg"}'
face_img_path = f'{images_path / "images" / "ai" / "ai_face.svg"}'
ring_img_path = f'{images_path / "images" / "ai" / "ai_ring.svg"}'
...
class qfi_ADI (QGraphicsView):
    ...
    def init (self):
        ...
        self.m_itemBack = QGraphicsSvgItem(back_img_path)
        ...
        self.m_itemRing = QGraphicsSvgItem(ring_img_path)
        ...
        self.m_itemCase = QGraphicsSvgItem(item_img_path)

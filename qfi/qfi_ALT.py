...
face1_img_path = f'{images_path / "images" / "alt" / "alt_face_1.svg"}'
face2_img_path = f'{images_path / "images" / "alt" / "alt_face_2.svg"}'
face3_img_path = f'{images_path / "images" / "alt" / "alt_face_3.svg"}'

hand1_img_path = f'{images_path / "images" / "alt" / "alt_hand_1.svg"}'
hand2_img_path = f'{images_path / "images" / "alt" / "alt_hand_2.svg"}'
case_img_path  = f'{images_path / "images" / "alt" / "alt_case.svg"}'
...
class qfi_ALT (QGraphicsView):
    ...
    def init (self):
        ...
        self.m_itemFace_1 = QGraphicsSvgItem(face1_img_path)
        ...
        self.m_itemFace_2 = QGraphicsSvgItem(face2_img_path)
        ...
        self.m_itemFace_3 = QGraphicsSvgItem(face3_img_path)
        ...
        self.m_itemHand_1 = QGraphicsSvgItem(hand1_img_path)
        ...
        self.m_itemHand_2 = QGraphicsSvgItem(hand2_img_path)
